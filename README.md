...
local OrionLib = {
	...
	Connections = {},
	Flags = {},
	-- [NOVO] Adicionado Evento de Favoritos
	...
	function Functions:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				-- [NOVO] Lógica de nome original para o sistema de favoritos
				ButtonConfig.OriginalName = ButtonConfig.OriginalName or tostring(ButtonConfig.Name or "")

				-- [NOVO] Lógica para detectar se é um script favoritável (usando o separador " / " do Open Sourcezada)
				...
				-- [NOVO] Criação do botão de estrela
				local FavoriteButton = ButtonConfig.CanFavorite and SetProps(MakeElement("ImageButton", "http://www.roblox.com/asset/?id=109586771228631"), { -- ID da estrela
					Size = UDim2.new(0, 20, 0, 20),
					Position = UDim2.new(1, -55, 0, 8), -- Posição ajustada para o layout do SC
					ZIndex = 25,
					Name = "Favorite",
					BackgroundTransparency = 1
				})
				...
				local ButtonFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 8), {
					...
					-- [NOVO] Adiciona o botão de favorito na hierarquia se permitido
				...
				-- [NOVO] Conexão do evento de favorito
